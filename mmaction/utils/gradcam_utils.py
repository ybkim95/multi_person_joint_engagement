...
class GradCAM:
    ...
    def _alpha_blending(self, localization_map, input_imgs, alpha):
        ...
        return blended_imgs, (1-alpha)*curr_inp, alpha*heatmap
    ...
    def __call__(self, inputs, use_labels=False, alpha=0.5):
        ...
        blended_imgs, orig_imgs, heat_imgs = self._alpha_blending(localization_map, inputs['imgs'],
                                            alpha)
        ...
        #print("[INFO] inputs:", inputs.keys())
        #print("[INFO] blended_imgs:", blended_imgs.shape)
        #print("[INFO] preds:", preds)

        return blended_imgs, preds, orig_imgs, heat_imgs
