...
ann_file_train = '/u/ybkim95/mmaction2/data/cvtriadic/custom_train_list.txt'
ann_file_val = '/u/ybkim95/mmaction2/data/cvctriadic/custom_val_list.txt'
ann_file_test = '/u/ybkim95/mmaction2/data/cvtriadic/custom_test_list.txt'
...
# runtime settings
work_dir = './work_dirs/slowfast_custom_cv'
