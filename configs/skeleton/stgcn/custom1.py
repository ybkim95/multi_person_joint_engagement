...
log_level = 'INFO'
work_dir = './work_dirs/stgcn/custom1/'
load_from = 'https://download.openmmlab.com/mmaction/skeleton/stgcn/stgcn_80e_ntu60_xsub_keypoint/stgcn_80e_ntu60_xsub_keypoint-e7bb9653.pth' 
resume_from = None
workflow = [('train', 1)]
